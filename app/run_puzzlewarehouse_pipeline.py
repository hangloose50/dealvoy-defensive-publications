...
from app.pipelines.puzzlewarehouse_scraper import PuzzlewarehouseScraper
...
def main():
    ...
    scraper = PuzzlewarehouseScraper(upc_service=upc_svc)

    queries = 

    all_items = []
    for q in queries:
        print(f"🔍 Searching '{q}' on puzzlewarehouse")
