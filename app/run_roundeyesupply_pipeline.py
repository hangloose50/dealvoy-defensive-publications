...
from app.pipelines.roundeyesupply_scraper import RoundeyesupplyScraper
...
def main():
    ...
    scraper = RoundeyesupplyScraper(upc_service=upc_svc)

    queries = 

    all_items = []
    for q in queries:
        print(f"🔍 Searching '{q}' on roundeyesupply")
