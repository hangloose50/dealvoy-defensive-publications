...
from app.pipelines.empirediscount_scraper import EmpirediscountScraper
...
def main():
    ...
    scraper = EmpirediscountScraper(upc_service=upc_svc)

    queries = 

    all_items = []
    for q in queries:
        print(f"🔍 Searching '{q}' on empirediscount")
